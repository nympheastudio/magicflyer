<?php return array (
  ...
  'CustomizationControllerCore' => 
  array (
    'path' => 'controllers/front/CustomizationController.php',
    'type' => 'class',
    'override' => false,
  ),
  'CustomizationCore' => 
  ...
  'cartePapillonController' => 
  array (
    'path' => 'override/controllers/front/cartePapillonController.php',
    'type' => 'class',
    'override' => false,
  ),
  'perso_coeurController' => 
  array (
    'path' => 'override/controllers/front/perso_coeurController.php',
    'type' => 'class',
    'override' => false,
  ),
  'perso_livretController' => 
  array (
    'path' => 'override/controllers/front/perso_livretController.php',
    'type' => 'class',
    'override' => false,
  ),
  'perso_mignognetteController' => 
  array (
    'path' => 'override/controllers/front/perso_mignognetteController.php',
    'type' => 'class',
    'override' => false,
  ),
  'perso_papillonController' => 
  array (
    'path' => 'override/controllers/front/perso_papillonController.php',
    'type' => 'class',
    'override' => false,
  ),
  'perso_papillonorController' => 
  array (
    'path' => 'override/controllers/front/perso_papillonorController.php',
    'type' => 'class',
    'override' => false,
  ),
  'personnalisationController' => 
  array (
    'path' => 'override/controllers/front/personnalisationController.php',
    'type' => 'class',
    'override' => false,
  ),
); ?>