...
class AuthControllerCore extends FrontController
{
    ...
    protected function processSubmitAccount()
    {
				...
				if (preg_match('/www|http/ui',$_POST['customer_lastname'])) {
            echo 'nom ou prenom ('.$_POST['customer_lastname'].') invalide !';exit;
        }			
		
		if (preg_match('/www|http/ui',$_POST['customer_firstname'])) {
            echo 'nom ou prenom ('.$_POST['customer_firstname'].') invalide !';exit;
        }		
