...
// echo 'maj panier -> mode: '.$mode. ', id_product:'.$this->id_product;
// echo '<br>';
// echo $product->hasAllRequiredCustomizableFields(). '--'.$this->customization_id;

// exit;
global $_GET;
            // Check customizable fields
            if (!$product->hasAllRequiredCustomizableFields() && !$this->customization_id) {
                $this->errors[] = Tools::displayError($_GET['id_customization'].'Please fill in all of the required fields, and then save your customizations. id='.$this->customization_id, !Tools::getValue('ajax'));
            }
