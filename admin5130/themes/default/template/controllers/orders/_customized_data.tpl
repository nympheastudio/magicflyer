			...
			<div class="form-group">
				...
				<div class="col-lg-8">
					{if substr(basename($data.value), 0, 1) == 'P'}
						<a href="{$pic_dir}{$data.value}" target="_blank">Télécharger le fichier du client</a>
					{else}
								...
								{foreach from=$datas item=data}
									<div class="form-group">
										...
										<div class="col-lg-8">
											...
											{if $data['name'] =='Image'}
											<a href="https://www.magicflyer.com/img/upload_fairepart/{$data['value']}" target="_blank">
											<img src="https://www.magicflyer.com/img/upload_fairepart/{$data['value']}" style="width: 200px;" />
											{else}
											{$data['value']}
											{/if}
