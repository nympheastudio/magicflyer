...
<table id="total-tab" width="100%">
	...
	<tr>
		<td class="grey" width="50%">
			{l s='Total Products' pdf='true'} {l s='(Tax excl.)' pdf='true'}
		</td>
		...
		<tr>
		<td class="grey" width="50%">
			{l s='Total Products' pdf='true'} {l s='(Tax incl.)' pdf='true'}
		</td>
		<td class="white" width="50%">
	...
	<tr>
		<td class="grey" width="50%">
			{l s='Shipping Cost' pdf='true'} {l s='(Tax excl.)' pdf='true'}
		</td>
		<td class="white" width="50%">
	...
	<tr class="bold">
		<td class="grey">
			{l s='Total' pdf='true'}  {l s='(Tax excl.)' pdf='true'}
		</td>
		<td class="white">
