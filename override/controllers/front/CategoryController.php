...
class CategoryControllerCore extends FrontController
{
    ...
    public function initContent()
    {
        parent::initContent();
				...
				//si cat 63 (carte perso on verifie les papillon du panier)
		...
		if($id_category==63){
			...
			foreach ($products as $product) {
				...
				if($product['id_product']== 309 ){
					
					//echo 'PAP qty allowed'. $product['cart_quantity'] ;
					$this->context->smarty->assign('pap_qty_allowed', $product['cart_quantity']);
				}
