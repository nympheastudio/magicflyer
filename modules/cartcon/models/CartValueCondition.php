 ...
 * support@mypresta.eu
 */
class CartValueCondition extends ObjectModel {
    public $id_cartcon_value;
    public $c_type;
    public $c_target;
    public $c_value;
    public $c_group;
    ...
    public static $definition = array(
        'table' => 'cartcon_value',
        'primary' => 'id_cartcon_value',
        'multilang' => false,
        'fields' => array(
            'id_cartcon_value' => array('type' => ObjectModel :: TYPE_INT),
    ...
    public function returnAllActive() {
        ...
        $record = Db::getInstance(_PS_USE_SQL_SLAVE_)->ExecuteS('SELECT * FROM `'._DB_PREFIX_.'cartcon_value` WHERE active="1"');
        return $record;
    }

    public function __construct($id_cartcon_value = NULL) {

        parent::__construct($id_cartcon_value);
    }
}