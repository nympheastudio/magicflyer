...
class PayboxHtmlWriter extends PayboxHtmlWriterAbstract
{
    ...
    {
        $this->html(sprintf('<h2><a class="toolbar_btn btn-help" href="%s" target="_blank" title="%s" style="float:right;font-size:0.8em;">%s <i class="process-icon-help" style="display:inline;"></i></a></h2>', $this->escape($link), $this->escape($subtitle), $this->escape($title)));
    }
}
