...
(function ($csocjqPm, window, document) {
    ...
    var Carousel = {
        init : function (options, el) {
            ...
            base.options = $csocjqPm.extend({}, $csocjqPm.fn.owlCarousel.options, base.$elem.data(), options);
        ...
        buildControls : function () {
            ...
            if (base.options.navigation === true || base.options.pagination === true) {
                base.owlControls = $csocjqPm("<div class=\"owl-controls\"/>").toggleClass("clickable", !base.browser.isTouch).appendTo(base.$elem);
            }
        ...
        buildButtons : function () {
            var base = this,
                buttonsWrapper = $csocjqPm("<div class=\"owl-buttons\"/>");
            ...
            buttonsWrapper.on("touchend.owlControls mouseup.owlControls", "div[class^=\"owl\"]", function (event) {
                event.preventDefault();
                if ($csocjqPm(this).hasClass("owl-next")) {
                    base.next();
                } else {
                    base.prev();
                }
        ...
        buildPagination : function () {
            ...
            base.paginationWrapper = $csocjqPm("<div class=\"owl-pagination\"/>");
            base.owlControls.append(base.paginationWrapper);

            base.paginationWrapper.on("touchend.owlControls mouseup.owlControls", ".owl-page", function (event) {
                event.preventDefault();
                if (Number($csocjqPm(this).data("owl-page")) !== base.currentItem) {
                    base.goTo(Number($csocjqPm(this).data("owl-page")), true);
                }
            });
        },
        ...
        checkPagination : function () {
            ...
            base.paginationWrapper.find(".owl-page").each(function () {
                if ($csocjqPm(this).data("owl-roundPages") === $csocjqPm(base.$owlItems[base.currentItem]).data("owl-roundPages")) {
        ...
        gestures : function () {
            ...
            function dragMove(event) {
                ...
                if ((base.newPosY > 10 || base.newPosY < -10) && locals.sliding === false) {
                    $csocjqPm(document).off("touchmove.owl");
                }
    ...
    $csocjqPm.fn.owlCarousel = function (options) {
        return this.each(function () {
            if ($csocjqPm(this).data("owl-init") === true) {
                return false;
            }
            $csocjqPm(this).data("owl-init", true);
            var carousel = Object.create(Carousel);
            carousel.init(options, this);
            $csocjqPm.data(this, "owlCarousel", carousel);
        });
    };

    $csocjqPm.fn.owlCarousel.options = {
