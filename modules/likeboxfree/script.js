...
var likebox_bgon = document.getElementById("new_likebox_bgon").checked;
var likebox_bgcolor = document.getElementById("new_likebox_bgcolor").value;
...
if(likebox_bgon=="1"){
    bgcolor="background: #"+likebox_bgcolor+";"
} 

document.getElementById("likeboxpreview").innerHTML="<div style='margin:auto; "+bgcolor+"; display:block; width:"+likebox_width+"px; border:1px solid #"+likebox_bordercolor+"'><iframe src=\"//www.facebook.com/plugins/likebox.php?href="+likebox_fanpageurl+"&amp;width="+likebox_width+"&amp;height="+likebox_height+"&amp;colorscheme="+likebox_colorscheme+"&amp;show_faces="+likebox_showfaces+"&amp;show_border=false&amp;stream="+likebox_showstream+"&amp;header="+likebox_showheader+"&amp;appId=112465995526913\" scrolling='no' frameborder='0' style=\"border:none; overflow:hidden; width:"+likebox_width+"px; height:"+likebox_height+"px;\" allowTransparency='true'></iframe></div>";
}