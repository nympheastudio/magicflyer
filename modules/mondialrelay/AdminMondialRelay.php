...
class AdminMondialRelay extends AdminTab
{
    ...
    private function displayOrdersTable()
    {
        ...
        if (version_compare(_PS_VERSION_, '1.5', '>=')) {
            $this->context->smarty->assign('MR_ajax_url', urlencode(Context::getContext()->link->getModuleLink('mondialrelay', 'ajax', array(), true)));
        } else {
            $this->context->smarty->assign('MR_ajax_url', urlencode('index.php?fc=module&module=mondialrelay&controller=ajax'));
        }
