...
*}
<header {if $class_header}class="{$class_header|escape:'html':'UTF-8'}"{/if}>
	...
	<div {if $row.class}class="{$row.class|escape:'html':'UTF-8'}"{/if}>
		<div {if $row.fullwidth == 0}class="container"{/if}>
			...
			{foreach from=$row.positions item=position}
				<div class="header-position {$position.class_suffix|escape:'html':'UTF-8'} col-lg-{$position.col_lg|escape:'html':'UTF-8'} col-sm-{$position.col_sm|escape:'html':'UTF-8'} col-md-{$position.col_md|escape:'html':'UTF-8'} col-xs-{$position.col_xs|escape:'html':'UTF-8'}">
