...
class Lnp2GetParcelTrackingRequestWS extends Lnp2WSObject
{
    public $fields = array(
    ...
    public function validateParams($params)
    {
        ...
        if (!Validate::isString($params['reference'])) {
            $this->validation_errors[] = 'reference is not a alphanumeric string';
        }
    }
}
