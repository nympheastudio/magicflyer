...
class Lnp2GetLabelRequestWS extends Lnp2WSObject
{
    public $fields = array(
        'partnerName' => array('required' => true),
        'orderNumber' => array('required' => true),
    );
    ...
    public function validateParams($params)
    {
        ...
        if (!Validate::isString($params['orderNumber'])) {
            $this->validation_errors[] = 'orderNumber is not a alphanumeric string';
        }
    }
}
