...
<span class="btn-group-action">
	<span class="btn-group">
        ...
        &nbsp;
		<a class="btn btn-default"
           href="index.php?controller=Lnp2PickupOrderPage&token={getAdminToken tab='Lnp2PickupOrderPage'}&id_order={$id_order|escape:'html':'UTF-8'}&preparation_state=1">
			{l s='Shipment sent' mod='lanavettepickup'}
		</a>
    </span>
</span>
