...
class AdminAmazonProductsController extends ModuleAdminController
{
    ...
    public function renderForm()
    {
        ...
        if ($this->ps17x) {
            ...
            $this->addCSS($this->url.'views/css/ProductsAmazon16.css', 'screen');
            $this->addCSS($this->url.'views/css/ProductsAmazon17.css', 'screen');
        } elseif ($this->ps16x) {
            $this->addCSS($this->url.'views/css/admin_controller/general16.css', 'screen');
            $this->addCSS($this->url.'views/css/ProductsAmazon16.css', 'screen');
        } else {
        ...
        $this->context->smarty->assign('deletion', AmazonConfiguration::get('DELETE_PRODUCTS'));
