...
class AdminImportChronopostController extends ModuleAdminController
{
    public function __construct()
    {
        ...
        $this->fields_options = array(
            'general' => array(
                'title' => $this->l('Management of imports using a third-party application (eg : Chronoship 
        ...
        $this->displayInformation($this->l('Use this function to massively assign Chronopost parcel numbers to 
the desired orders. This is useful if you edit your waybills from a third-party application. (Eg ChronoShip Office 
ChronoShip Station ...). The expected file must be in CSV format with semicolon separator.<br/><br/>It must contain 
2 columns : <ol><li>Prestashop orders reference</li><li>Chronopost tracking number</li></ol><br/>The orders status 
will be "Shipment in transit". An email contaning the tracking number and a link to follow the parcel will be sent 
to the customer.'));
    }
