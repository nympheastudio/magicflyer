...
class AdminBordereauChronopostController extends ModuleAdminController
{
    public function __construct()
    {
        ...
        $this->fields_list = array(
            ...
            'customer' => array('title' => $this->l('Customer'), 'widthColumn' => 160, 'width' => 140,
                                'filter_key' => 'customer', 'tmpTableFilter' => true),
            ...
            'date_add' => array('title' => $this->l('Date'), 'width' => 35, 'align' => 'right',
    ...
    {
        return Translate::getModuleTranslation('chronopost', $string, Tools::substr(get_class($this), 0, -10), null,
            false);
    }
}
