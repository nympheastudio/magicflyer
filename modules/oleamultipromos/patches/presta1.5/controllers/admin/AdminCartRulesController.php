...
// File Copied from 1.5.3.1
// Serach for Oleacorner string
...
class AdminCartRulesControllerCore extends AdminController
{
	public function __construct()
	{
		...
		// Oleacorner
			'is_for_oleamultipromo' => array('title' => $this->l('isMultiPromo'), 'align' => 'center', 'type' => 'bool', 				
						'icon' => array(0 => 'disabled.gif', 1 => 'enabled.gif', 'default' => 'disabled.gif'), 'orderby' => true),
		// End Oleacorner
		);
