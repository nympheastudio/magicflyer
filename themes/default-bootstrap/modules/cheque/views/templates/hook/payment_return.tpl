...
{if $status == 'ok'}
    ...
    <h3 class="page-subheading">{l s='Your check must include:' mod='cheque'}</h3>
		...
		<br />- {l s='For any questions or for further information, please contact our' mod='cheque'} <a href="forms/3/Contact">{l s='customer service department.' mod='cheque'}</a>.
	</div>
{else}
	<p class="alert alert-warning">
		...
		<a href="forms/3/Contact">{l s='customer service department.' mod='cheque'}</a>.
	</p>
{/if}