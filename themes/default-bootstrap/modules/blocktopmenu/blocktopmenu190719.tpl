...
$(document).ready(function(){
	...
	if(lang_iso=='fr'){
		$('.sf-menu li ul').eq(0).append('<li><a href="https://www.magicflyer.com'+lang_iso+'/53-articles-deco">Accessoires</a></li><li style="display:none"><a href="https://www.magicflyer.comfr/64-cartes-de-voeux-2019-personnalisables">Carte de voeux</a></li>');
		...
		$('.sf-menu li a').eq(8).attr('href','https://www.magicflyer.comfr/content/42-professionnels');
		...
		$('.sf-menu li ul li a').eq(11).attr('href','https://www.magicflyer.comfr/forms/3/Contact');
		$('.sf-menu li ul').eq(3).append('<li><a href="http://www.magicflyer.com/'+lang_iso+'/index.php?fc=module&module=jmsblog&controller=category&category_id=1">{l s="Prestige" mod="blockuserinfo" }</a></li>');
	...
	if(lang_iso=='en'){
		...
		$('.sf-menu li ul').eq(0).append('<li><a href="https://www.magicflyer.com'+lang_iso+'/53-decoration-accessories">Accessories</a></li><li style="display:none"><a href="https://www.magicflyer.comfr/64-cartes-de-voeux-2019-personnalisables">New year cards</a></li>');
		...
		//$('.sf-menu li ul').eq(3).append('<li><a href="https://www.magicflyer.comen/content/49-prestige">Gallery</a></li>');
		
		$('.sf-menu li ul li a').eq(12).attr('href','https://www.magicflyer.comen/content/6-instructions-of-use');
		
		
		$('.sf-menu li a').eq(8).attr('href','https://www.magicflyer.comen/content/42-professionnels');//
		...
		$('.sf-menu li ul li a').eq(11).attr('href','https://www.magicflyer.comen/forms/3/contact-information');
		$('.sf-menu li ul').eq(3).append('<li><a href="http://www.magicflyer.com/'+lang_iso+'/index.php?fc=module&module=jmsblog&controller=category&category_id=1">{l s="Prestige" mod="blockuserinfo" }</a></li>');
	...
	if(lang_iso=='es'){
		...
		$('.sf-menu li ul').eq(0).append('<li><a href="https://www.magicflyer.com'+lang_iso+'/53-accesorios">Accesorios</a></li><li style="display:none"><a href="https://www.magicflyer.com'+lang_iso+'/64-module-cartes" >Tarjetas de felicidades</a></li>');
		...
		$('.sf-menu li ul li a').eq(12).attr('href','https://www.magicflyer.comes/content/6-intrucciones-de-uso');
		
		
		$('.sf-menu li a').eq(8).attr('href','https://www.magicflyer.comes/content/42-profesionales');//
		
		$('.sf-menu li a').eq(8).click(function(e) {
			
			e.preventDefault();
			window.location.href = 'https://www.magicflyer.comes/content/42-profesionales';
			
		});

		$('.sf-menu li ul li a').eq(11).attr('href','https://www.magicflyer.comes/forms/3/contacto');
		
		
		$('.sf-menu li ul').eq(3).append('<li><a href="http://www.magicflyer.com/es/index.php?fc=module&module=jmsblog&controller=category&category_id=1">Prestigio</a></li>');
	...
	case 12:case 13:case 4:case 18:case 41:case 43:case 45:case 46:case 47:case 49:case 51:case 52:case 64:
