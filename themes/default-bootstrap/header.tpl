			...
			<div class="header-container col-lg-2 col-md-3 col-sm-12 col-xs-12">
				<header id="header">
					...
					<div class="header-left">
						<div class="container-fluid">
							<div class="row">
								<p class="animate-text">{l s='Site officiel de l\'inventeur Français'}</p>
								<div id="header_logo">
						...
						{if isset($HOOK_FOOTER)}
							...
							<div class="footer-container">
								<footer id="footer"  class="container">
									...
									<div class="copy">{l s='Tous droits réservés'}</div>
									
									<div class="copy"><a href="{$link->getCMSLink('3')}">{l s='CGV'}</a> | <a href="{$link->getCMSLink('2')}">{l s='Mentions légales'}</a></div>
			...
			<div class="columns-container col-lg-10 col-md-9 col-sm-12 col-xs-12  global-content">
				<div id="columns" class="container-fluid">
						...
						<div id="top_column" class="center_column">
							...
							Votre navigateur ne permet pas de lire les vidéos HTML5. </video>
							-->
							...
							<div class="mobile_only content_ac">
								...
								<div class="text-intro">
									<h1><span class="smalltext">{l s='Découvrez'}</span>{l s='Le messager de l\'émotion'}</h1>
									<a class="btn btn-primary" href="https://www.magicflyer.com/fr/content/65-boutique" title="{l s='Voir la boutique du papillon magique'}" >{l s='Aller à la boutique'}</a>
								</div>
					...
					<div class="pagecent">
						...
						<div id="leading-1" class="row page_scroll">
							...
							<div class="content_page">
								...
								<h2 class="titre">L'amour en héritage</h2>
								<p></p>
								<p>A la croisée de la poésie et du romantisme
									d’une histoire d’amour pour créer une invention unique !
								</p>
								<p>
									Il était une fois un inventeur de génie qui avait imaginé une idée folle : séduire
									sa belle avec un Papillon Magique. Mettant au point un ingénieux assemblage de fil
									de métal, d'élastique, de papier aux couleurs chatoyantes, il écrivit son message
								...
								<p>
									...
									délivrer à la jeune fille, le témoignage de ses sentiments.</p>
								<a title="Achetez vos cartes papillons et émerveillez vos invités"
									href="https://www.magicflyer.com/fr/content/43-le-papillon-magique-une-invention-de-genie"
									class="scroll_btn">Connaître toute l'histoire</a>
							</div>
						</div>
						<div class="row page_scroll" id="leading-2">
							...
							<div class="content_page">
								<h3 class="sous_titre">Le papillon Magique®</h3>
								<h2 class="titre">Découvrez l'incroyable performer <span>pour les entreprises</span>
								</h2>
								<p>Cette invention française dynamise votre communication d'entreprise. Composé d'un
									Papillon Magique® ultra léger muni de fines ailes en papier subtilement colorées et
									d'un élastique breveté, il s'envole dès l'ouverture de votre carte pour surprendre
									et émerveiller tous vos clients, vos prospects, vos partenaires.</p>
								<p>Avec un <strong>Taux de retour moyen de 20% en campagne de Marketing Direct</strong>,
									une <strong>Prise en main de plus de 10 personnes</strong> et une <strong>Rémanence
										de 5 ans minimum</strong>, Le Papillon Magique® générateur d'émotions, détient
									des records inégalés constatés par des centaines de références dans le monde</p>
								<p>Alors, faites comme Thomas Pesquet, les émissions Mask Singer ou mariés au premier
									regard, Céline Dion et bien d'autres qui rendent sa noblesse à cette incroyable
									invention !</p>



								<a href="https://www.magicflyer.com/fr/content/75-professionnels-2022"
									class="scroll_btn">Découvrir nos produits pour les pros</a>
							</div>
						</div>
									...
									<div class="col-xs-6 col-sm-3 block_boutiqueAC">
										<div><a href="https://www.magicflyer.com/fr/51-nos-papillons-magiques">
											<div class="img_boutiqueAC"><img src="/img/papillons-magiques.jpg"
													alt="Papillons magiques toutes catégories"></div>
											<div class="content_boutiqueAC">
												<h3>Papillons Magiques®</h3>
												<p>à partir de 19,50 €<br>/ 10 unités</p>
											</div>
										</a></div>
									</div>
									<div class="col-xs-6 col-sm-3 block_boutiqueAC">
										<div><a href="https://www.magicflyer.com/fr/content/66-cartes-papillon">
											...
											<div class="content_boutiqueAC">
												...
												<p>à partir de 30 €<br> / 10 cartes + 10 Papillons Magiques®</p>
											</div>
										</a></div>
									</div>
									<div class="col-xs-6 col-sm-3 block_boutiqueAC">
										...
										<a href="https://www.magicflyer.com/fr/index.php?controller=perso_livret">
											...
											<div class="content_boutiqueAC">
												...
												<p>à partir de 38 €<br>/ livret + 10 Papillons Magiques®</p>
											</div>
										</a></div>
									</div>
									<div class="col-xs-6 col-sm-3 block_boutiqueAC">
										<div><a href="https://www.magicflyer.com/fr/index.php?controller=perso_coeur">
											...
											<div class="content_boutiqueAC">
												<h3>Livret Coeur</h3>
												<p>à partir de 86 €<br>/ livret + 30 Papillons Magiques®</p>
											</div>
										</a></div>
									</div>
								</div>
						...
						<div id="leading-4" class="row page_scroll">
							...
							<div class="content_page">
								...
								<p>Suivez très attentivement nos tutoriels afin de préparer de façon optimale vos
									Livrets et Cartes Papillons.<br>
									Créez des sorties officielles extraordinaires ou des évènements féériques. Effet
									garanti à l'intérieur ou à l'extérieur. De plus, les Papillons Magiques sont
									réutilisables à volonté ! Générez des émotions positives qui resteront gravées dans
									votre mémoire et celle de vos invités durant de longues années... Un instant
									inoubliable qui marquera à jamais l'un des plus beaux jours de votre vie !</p>
								<a href="https://www.magicflyer.com/fr/content/6-tutoriel"
									class="scroll_btn">Nos tutos vidéo</a>
							</div>
						</div>
